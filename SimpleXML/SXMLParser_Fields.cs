...
namespace SimpleXML
{
    public abstract partial class SXMLParser
    {
        ...
        internal const int _hugeBufferSize = 4096 * 8;
        internal const int _maximumBufferSize = 4096 * 16;
        internal const int _maxBytesToMove = 128;
        // End constants

        // Settings
        internal SettingsData _settings;
        internal BufferStateData _bufferState;
        internal ParseStateData _parseState;
        // End settings
